      ...
      <div class="kt-portlet__body">
        ...
        >
          ...
          <div class="row table-responsive table_fixed_width">
              ...
              >
                ...
                <tbody v-auto-animate>
                  <tr
                    role="row"
                    class="odd"
                    v-for="request in props.customcutdryicerequest.data"
                    :key="request.id"
                  >
                    <td>{{ request.name }}</td>
                    <td>
            ...
            <div class="col-sm-12" v-if="customcutdryicerequest.total == 0">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-5">
            <div
              ...
              aria-live="polite"
            >
              Showing {{ customcutdryicerequest.from }} to {{ customcutdryicerequest.to }} of
              {{ customcutdryicerequest.total }} entries
            </div>
          </div>
          <div class="col-sm-12 col-md-7">
            <div class="float-right">
              <Bootstrap4Pagination
                :data="customcutdryicerequest"
                :limit="2"
...
onMounted(() => {
  emit.emit("pageName", "Custom Cut dry ice Management", [
    {
      title: "All Products",
      routeName: "admin.product.custom-cut-dryice",
    },
  ]);
